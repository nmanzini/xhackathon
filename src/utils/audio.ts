 ...
 * Used for Web Audio API capture and playback with XAI realtime API
 */

/**
 * Convert Float32Array to PCM16 and base64 encode
 * Used for sending microphone audio to the API
 */
 ...
 * Used for playing API audio responses through speakers
 */
